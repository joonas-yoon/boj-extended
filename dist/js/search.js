"use strict";var _interopRequireDefault=require("@babel/runtime/helpers/interopRequireDefault"),_defineProperty2=_interopRequireDefault(require("@babel/runtime/helpers/defineProperty"));function ownKeys(a,b){var c=Object.keys(a);if(Object.getOwnPropertySymbols){var d=Object.getOwnPropertySymbols(a);b&&(d=d.filter(function(b){return Object.getOwnPropertyDescriptor(a,b).enumerable})),c.push.apply(c,d)}return c}function _objectSpread(a){for(var b,c=1;c<arguments.length;c++)b=null==arguments[c]?{}:arguments[c],c%2?ownKeys(Object(b),!0).forEach(function(c){(0,_defineProperty2.default)(a,c,b[c])}):Object.getOwnPropertyDescriptors?Object.defineProperties(a,Object.getOwnPropertyDescriptors(b)):ownKeys(Object(b)).forEach(function(c){Object.defineProperty(a,c,Object.getOwnPropertyDescriptor(b,c))});return a}function extendQuickSearch(){async function a(a){if(v=!!a,!0===a){const a=(await i())||{};C.value=a.text||"",0<=a.tabIndex&&b(a.tabIndex),w=await fetchProblemsByUser(getMyUsername()),z.style.display="flex",setTimeout(()=>{C.focus()},10)}else z.style.display="none"}async function b(a){for(const b of y){const c=b.el.getAttribute(q)==a;c?b.el.classList.add("active"):b.el.classList.remove("active")}x.lock=!1,D.scroll(0,0),u=+a,await h({tabIndex:a}),c(C.value)}async function c(a,b){if(x.lock)return;if(x.lock=!0,b=b||0,0==b)D.innerHTML="",x.totalCount=0,D.scroll(0,0);else if(b>x.maxPage||b==x.curPage)return;await h({text:a});const c=y[u].c||"Problems",f=await d(a,c,b),{hits:g,processingTimeMS:i,nbHits:j,nbPages:k,page:l,message:m}=f;return m?void(x.lock=!0):void(x.totalCount+=g.length,x.maxPage=k,x.curPage=l,await e(D,c,f),F.href=encodeURI("/search#q="+a+"&c="+c),E.innerHTML=`${j}개의 결과 중 \
    ...
    `}function m(a){const{id:b,problems:c,creator:d,_highlightResult:e}=a,{name:g,comment:h,creator:i,problem:j}=e,k=(j||[]).filter(({problem_id:a,title:b})=>a.matchedWords.length||b.matchedWords.length).map(({problem_id:a,title:b})=>{const c=a.value.replace(/(<([^>]+)>)/gi,""),d=f(c);return`<span class="problem">\
    ...
    `}function n(a){const{avail:b,id:c,parents:d,total:e,_highlightResult:f}=a,{name:g}=f,h=(d||[]).map(a=>`<li><a href="/category/${a.id}">${a.name}</a></li>`).join("\n");return`\
    ...
    `}function o(a){const{id:b,user:c,comments:d,date:e,tags:f}=a,{title:g}=a._highlightResult,{content:h}=a._snippetResult,i=f.filter(a=>0<a.length).map(a=>`<span class="tag">#${a}</span>`).join("\n");return`\
    ...
    `}const q="tidx",r="qs-last-state";let s=null,t="",u=0,v=!1,w={};const x={totalCount:0,maxPage:0,curPage:0,lock:!1},y=[{title:"\uBB38\uC81C",c:"Problems",active:!0,el:null},{title:"\uBB38\uC81C\uC9D1",c:"Workbooks",el:null},{title:"\uCD9C\uCC98",c:"Categories",el:null},{title:"\uBE14\uB85C\uADF8",c:"Blogs",el:null},{title:"\uAC8C\uC2DC\uD310",c:"Articles",el:null}],z=Utils.createElement("div",{id:"quick-search",class:"overlay"}),A=Utils.createElement("div",{class:"container"}),B=Utils.createElement("div",{class:"form-group"}),C=Utils.createElement("input",{class:"form-control",placeholder:"\uAC80\uC0C9",autofucus:!0}),D=Utils.createElement("div",{class:"results"}),E=Utils.createElement("div",{class:"results-footer"});E.innerText="\uACB0\uACFC \uD45C\uC2DC (0.000\uCD08)";const F=Utils.createElement("a",{class:"btn btn-default more-button",href:"/search"});F.innerText="\uB354 \uB9CE\uC740 \uAC80\uC0C9 \uACB0\uACFC \uBCF4\uAE30",B.appendChild(C),B.appendChild(D);const G=Utils.createElement("div",{class:"tabs"});for(let a=0;a<y.length;++a){const c=y[a],d=Utils.createElement("div",{class:"tab",[q]:a,tabindex:-1});d.innerText=c.title,c.active&&d.classList.add("active"),d.addEventListener("click",a=>{a.preventDefault(),b(d.getAttribute(q))}),y[a].el=d,G.appendChild(d)}A.appendChild(G),A.appendChild(B),A.appendChild(E),A.appendChild(F),z.appendChild(A),document.body.appendChild(z);const H=document.createElement("li"),I=document.createElement("a");I.innerHTML="<i class=\"fa fa-search\"></i>",H.appendChild(I),I.addEventListener("click",b=>{b.preventDefault(),a(!0)}),addElementToBar(H),C.addEventListener("keyup",async a=>{a.preventDefault();const b=a.target.value,d=b.replace(/\s/g,"");t!==d&&(t=d,clearTimeout(s),s=setTimeout(()=>{b&&(x.lock=!1),c(b)},100))});const J=new Set;document.addEventListener("keydown",a=>{J.add(a.key),v&&"Tab"===a.key&&(u=J.has("Shift")?(u-1+y.length)%y.length:(u+1)%y.length,b(u),a.preventDefault())}),document.addEventListener("keyup",b=>{J.has("Escape")?a(!1):J.has("/")&&(J.has("Control")||J.has("Alt"))&&a(!0),J.delete(b.key)}),document.addEventListener("click",b=>{b.target==z&&a(!1)}),D.addEventListener("scroll",()=>{const a=g(D);.99<=a&&c(C.value,x.curPage+1)})}async function extendSearchPage(){function a(a){a.querySelectorAll("a[href^=\"/problem/\"]").forEach(a=>{const b=getProblemID(a.href);b&&c[b]&&a.classList.add(c[b])})}const b=document.getElementById("result").getElementsByClassName("results")[0];if(!b)return void setTimeout(extendSearchPage,10000);const c=await fetchProblemsByUser(getMyUsername());if(!c)return;const d=new MutationObserver(function(b){0==b.length||a(b[0].target)});d.observe(b,{attributes:!0,childList:!0,characterData:!0}),a(b)}